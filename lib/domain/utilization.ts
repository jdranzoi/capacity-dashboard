...
//
// Org weekly-detail **Capacity fill** row: logged vs prorated net capacity (`capacityFillPct`);
// per-person **Utilization** pace: `personLoggedUtilizationPct` — see lib/domain/workload-metrics.ts and CLAUDE.md.
